...
# +
from src.utils.dataloader import create_dataloader_train
from src.utils.dataloader import create_dataloader_eval
from src.utils.writer import MyWriter
from src.utils.stft import TacotronSTFT
...
#             print(mel_fake.shape, mel_real.shape)
...
#             print(z_p.mean(), logs_q.mean(), m_p.mean(), logs_p.mean())
