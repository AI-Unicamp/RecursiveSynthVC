...
if __name__ == '__main__':
    ...
    parser.add_argument("-s", "--source", help="source", dest="source", required=True)
    parser.add_argument("-d", "--dest", help="dest", dest="dest", required=True)
...
#     __OUTPATH__ = '/project/sughosh/dataset/VCTK-24k-All/'
    __CORPUSPATH__ = args.source
    __OUTPATH__ = args.dest
