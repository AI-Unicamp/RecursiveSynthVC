...
#                 continue
            if not os.path.isfile(melspec16):
                continue
...
#         print(pit.shape, melspec16.shape, spe.shape)
#         if len_min > use:
#             max_frame_start = melspec16.size(1) - use - 1
...
# #             melspec16 = melspec16[frame_start:frame_end, :]
#             melspec16 = melspec16[:,frame_start:frame_end]
...
#         print(melspec16_padded.shape)
#         print(melspec16_padded.shape, pit_padded.shape, spe_padded.shape)
        return (
            melspec16_padded,
            ppg_lengths,
#             vec_padded,
